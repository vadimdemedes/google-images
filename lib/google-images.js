...
(function() {
  ...
  exports.search = function(query, options) {
    ...
    return request("http://ajax.googleapis.com/ajax/services/search/images?v=1.0&q=" + (encodeURIComponent(query.replace(/\s/g, '+'))) + "&start=" + options.page + "&imgsz=" + options.size, function(err, res, body) {
